...
files = %w{core.js input.js assets.js game_loop.js rect.js sprite.js sprite_sheet.js animation.js viewport.js collision_detection.js pixel_map.js parallax.js text.js quadtree.js tile_map.js tmx_map.js extras/tile_map_pathfinding.js gamepad.js uuid.js}.map { |file| "src/#{file}"}
